    ...
    return (
        <Modal.Dialog className='custom-modal-container'>
          ...
          <div className="grid-container">
            ...
            <div className="grid-item"> <MainButton variant="primary">This is a two lines button that terminates with  </MainButton></div>
            <div className="grid-item"> <MainButton variant="primary" customClass="custom-btn-position">This is a two lines button that terminates with </MainButton></div>
            <div className="grid-item"> <MainButton variant="disable" customClass="custom-btn-position">This is a two lines button that terminates with </MainButton></div>
            <div className="grid-item"> <MainButton variant="primary" customClass="custom-btn-position">This is a two lines button that terminates with </MainButton></div>
        </div>
          </Modal.Body>
        </Modal.Dialog>
